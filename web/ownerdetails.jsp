<%-- 
    ...
    Created on : Sep 5, 2024, 11:20:05 AM
    Author     : chait
--%>
...
<body>
        ...
        <a href="ownerdetails.jsp" class="active">Owner Details</a>
        <a href="userdetails.jsp">User Details</a>
        <a href="Admin.jsp">Logout</a>
    </nav>
</header>
    <div class="container">
        <center><h1 style="color: black">Owners Details</h1></center><br>
                                 ...
                                 <tbody>
                                        <%
                                            ...
                                            try {
                                                ...
                                                String sqlQuery = "select * from dataownerregister";
                                        ...
                                        <tr style="color: whitesmoke">
                                            ...
                                            <td>
                                                ...
                                                %>
                                                <a class="primary-btn" href="useractivate.jsp?id=<%=id%>">Activate</a>
                                                <%
                                                    }
                                                %>
                                            </td>
